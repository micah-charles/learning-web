...
## Q1.1: Which one of the following does not affect a person’s karma?
...
Answer: D Their appearance

---

## Q1.2: Give two forms of the Dharma in Hinduism.
...
## Q1.3: Explain two ways in which believing that Brahman can be shown in form (Saguna)

influences Hindus today.
...
## Q1.4: Explain two Hindu teachings about samsara.

Refer to sacred writings or another source of Hindu belief and teaching in your
answer.
...
## Q1.5: ‘For Hindus, love is the most important of the personal virtues.’
...
## Q2.1: At a Hindu home shrine, which one of the following is the murti?

Put a tick () in the box next to the correct answer.
A Flowers
B Image of the deity
C Incense
D Offerings to the deity

**Answer:**

beliefs, practices and sources of authority
Answer: B – Image of the deity

---

## Q2.2: Give two of the four paths towards yoga (union with the divine).
...
## Q2.3: Explain two contrasting ways in which Holi is celebrated by Hindus.
...
## Q2.4: Explain two reasons why Hindus use different places for worship.
...
## Q2.5: ‘For Hindus, pilgrimage is the best way to show devotion to God.’
